...
# Embedded Base64 Logo (Generates clean Shadow Point graphic natively)
LOGO_HTML = """
<div style="display: flex; align-items: center; gap: 12px; margin-bottom: 10px;">
    <svg width="45" height="45" viewBox="0 0 70 70" fill="none" xmlns="http://www.w3.org/2000/svg">
        <polygon points="35,5 65,20 65,50 35,65 5,50 5,20" fill="#1E293B" />
        <polygon points="35,12 55,23 55,42 35,53 15,42 15,23" fill="#0EA5E9" />
        <circle cx="35" cy="35" r="7" fill="#FFFFFF" />
    </svg>
    <div>
        <h2 style="margin: 0; padding: 0; color: #0F172A; font-family: sans-serif; font-weight: 800; font-size: 24px; line-height: 1;">SHADOW POINT</h2>
        <span style="color: #0EA5E9; font-family: sans-serif; font-size: 11px; font-weight: 600; letter-spacing: 2px;">GCC ENTERPRISE ENGINE</span>
    </div>
</div>
"""
...
# ==========================================
    ...
    with header_right:
        st.write(" ")
        search_keyword = st.text_input("🔍 Quick Keyword Search", placeholder="Type name, machinery, location...")
